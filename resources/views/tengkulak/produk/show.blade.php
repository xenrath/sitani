  ...
  <div class="row g-0">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        @if ($produk->stok != 0)
        {{-- <button type="button" for="button" class="btn rounded-pill mt-4"
          style="background-color: #25D366; color: white;" data-bs-toggle="modal" data-bs-target="#modaltawar" <i
          class="x-bx-dollar-circle"></i>
          <i class="bx bxl-whatsapp"></i>
          <span class="align-middle">Lakukan penawaran</span>
        </button> --}}
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalKonfirmasiBiasa"
          id="btn-konfirmasi-biasa" style="display: none">Konfirmasi
          Biasa</button>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalKonfirmasiTebas"
          id="btn-konfirmasi-tebas" style="display: none">Konfirmasi
          Tebas</button>
...
<form action="{{ url('tengkulak/produk/tawar/' . $produk->id) }}" method="POST" id="form-tawar">
  @csrf
  <div class="modal fade" id="modaltawar" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none" <div
    class="modal fade" id="modalKonfirmasiTebas" aria-labelledby="modalToggleLabel" tabindex="-1" style="display: none"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="form-group mb-3 p-3">
          ...
          <input type="text" class="form-control" name="tawar" id="tawar" placeholder="masukan tawaran"
            value="{{ old('tawar') }}" />
          <input type="hidden" class="form-control" id="jumlah" name="jumlah" value="1">
        </div>
        <div class="modal-footer">
